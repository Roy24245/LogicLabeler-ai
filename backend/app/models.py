...
class Dataset(Base):
    ...
    keypoint_schema: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
...
class Annotation(Base):
    ...
    shape_type: Mapped[str] = mapped_column(String(16), default="bbox")
    bbox: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
    points: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True)
